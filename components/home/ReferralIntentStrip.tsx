...
export function ReferralIntentStrip() {
  return (
    <section className="bg-landing-blue py-8">
      <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-4 sm:flex-row">
        ...
        <div className="flex flex-wrap justify-center gap-3">
          <Link
            ...
            className="inline-flex items-center gap-2 rounded-md bg-white px-5 py-2.5 text-sm font-bold text-landing-blue transition-all hover:scale-[1.02] hover:shadow-lg"
          >
            Start as Referrer
