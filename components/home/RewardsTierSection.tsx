      ...
      <div className="mx-auto max-w-6xl px-4">
        <div className="text-center">
          <h2 className="text-2xl font-bold text-landing-navy md:text-3xl">
            ...
            <span className="text-landing-orange">Earn rewards!</span>
          </h2>
        ...
        <div className="mt-10 flex flex-col items-center gap-8 md:flex-row md:justify-center">
          <div className="flex h-32 w-32 shrink-0 items-center justify-center rounded-2xl bg-landing-orange/10 ring-1 ring-landing-orange/20">
            <Gift className="h-16 w-16 text-landing-orange" />
          </div>
          ...
          <div className="grid w-full max-w-2xl gap-3 sm:grid-cols-3">
            {tiers.map((tier) => (
              <div
                key={tier.day}
                className="rounded-xl border border-landing-orange/20 bg-white p-5 text-center shadow-card transition-all duration-300 hover:-translate-y-1 hover:shadow-card-hover"
              >
                <p className="text-xs font-semibold uppercase tracking-wider text-landing-orange">
                  Day {tier.day}
                </p>
